            ...
            switch(uiAction)
            {
                ...
                case 1:
  				...
  				pPlayer->ADD_GOSSIP_ITEM(4, "Vanquisher (500 PvP Tokens)", GOSSIP_SENDER_MAIN, 32);
					...
					case 4:
                        if (pPlayer->HasItemCount(45624, 25, true))
                        {
                   ...
                   case 12:
                       if (pPlayer->HasItemCount(45624, 50, true))
                       {
                           pPlayer->DestroyItemCount(45624, 25, true);
                   ...
                   case 13:
                       if (pPlayer->HasItemCount(45624, 50, true))
                       {
                           pPlayer->DestroyItemCount(45624, 50, true);
                   ...
                   case 22:
                       if (pPlayer->HasItemCount(45624, 250, true))
                       {
                           pPlayer->DestroyItemCount(45624, 250, true);
                  ...
                  case 32:
                      if (pPlayer->HasItemCount(45624, 500, true))
                      {
                          pPlayer->DestroyItemCount(45624, 500, true);
				 ...
				 case 35:
                     if (pPlayer->HasItemCount(45624, 750, true))
                     {
                         pPlayer->DestroyItemCount(45624, 750, true);
				 ...
				 case 37:
                     if (pPlayer->HasItemCount(45624, 1000, true))
                     {
                         pPlayer->DestroyItemCount(45624, 1000, true);
				 ...
				 case 49:
                     if (pPlayer->HasItemCount(45624, 15, true))
                     {
                         pPlayer->DestroyItemCount(45624, 15, true);
